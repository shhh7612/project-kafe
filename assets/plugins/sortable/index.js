...
document.addEventListener('click', function (e) {
    try {
        ...
        function getValue(element) {
            ...
            var value = (alt_sort && element.getAttribute('data-sort-alt')) || element.getAttribute('data-sort') || element.innerText;
            return value;
        ...
        if (regex_table.test(table.className)) {
            ...
            if (
                ...
                (table.className.indexOf(ascending_table_sort_class) !== -1 && element.className.indexOf(ascending_th_class) == -1)
            ) {
